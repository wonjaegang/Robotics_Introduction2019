...
void setup() 
{
  ...
  delay(2000);
  draw_line(x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2 + 30 + z1, x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2 + z1,     30);
  draw_line(x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2  + z1,     (x2+x1)/2 - (6 / 150) * (75- (x2+x1)/2) + 3, 70+(x2+x1)/2, 9/150 * (45 - (x2+x1)/2) - 2 + z2,     30);
  draw_line((x2+x1)/2 - (6 / 150) * (75- (x2+x1)/2) + 3, 70+(x2+x1)/2, 9/150 * (45 - (x2+x1)/2) - 2  + z1,     x2 - (6 / 150) * (75- x2) + 3, 70+y2, 9/150 * (45 - x2) - 2 + z2,     30);
  draw_line(x2 - (6 / 150) * (75- x2) + 3, 70+y2, 9/150 * (45 - x2) - 2  + z2,     x3 - (6 / 150) * (75- x3) + 3, 70+y3, 9/150 * (45 - x3) - 2 + z3,     30);
  draw_line(x3 - (6 / 150) * (75- x3) + 3, 70+y3, 9/150 * (45 - x3) - 2  + z3,     x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2 + z1,     30);
  draw_line(x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2  + z1,     x1 - (6 / 150) * (75- x1) + 3, 70+y1, 9/150 * (45 - x1) - 2 + z1+ 10, 30);
